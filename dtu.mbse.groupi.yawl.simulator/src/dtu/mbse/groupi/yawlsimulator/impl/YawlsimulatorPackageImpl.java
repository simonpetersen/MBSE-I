 ...
 * @generated
 */
public class YawlsimulatorPackageImpl extends EPackageImpl implements YawlsimulatorPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see dtu.mbse.groupi.yawlsimulator.YawlsimulatorPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private YawlsimulatorPackageImpl() {
		super(eNS_URI, YawlsimulatorFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link YawlsimulatorPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static YawlsimulatorPackage init() {
		if (isInited) return (YawlsimulatorPackage)EPackage.Registry.INSTANCE.getEPackage(YawlsimulatorPackage.eNS_URI);

		// Obtain or create and register package
		YawlsimulatorPackageImpl theYawlsimulatorPackage = (YawlsimulatorPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof YawlsimulatorPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new YawlsimulatorPackageImpl());
		...
		theYawlsimulatorPackage.createPackageContents();

		// Initialize created meta-data
		theYawlsimulatorPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theYawlsimulatorPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(YawlsimulatorPackage.eNS_URI, theYawlsimulatorPackage);
		return theYawlsimulatorPackage;
	}
