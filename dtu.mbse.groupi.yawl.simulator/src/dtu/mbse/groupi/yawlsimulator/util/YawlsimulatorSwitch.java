 ...
 * @generated
 */
public class YawlsimulatorSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case YawlsimulatorPackage.ENABLED_TRANSITION: {
			...
			case YawlsimulatorPackage.SELECT_ARC: {
			...
			case YawlsimulatorPackage.MARKING: {
