 ...
 * </p>
 * <ul>
 *   <li>{@link dtu.mbse.groupi.yawl.impl.ArcImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ArcImpl extends org.pnml.tools.epnk.pnmlcoremodel.impl.ArcImpl implements Arc {
	...
	public void setType(ArcType newType) {
		if (newType != type) {
			...
			if (type != null)
				msgs = ((InternalEObject)type).eInverseRemove(this, YawlPackage.ARC_TYPE__ARC, ArcType.class, msgs);
			if (newType != null)
				msgs = ((InternalEObject)newType).eInverseAdd(this, YawlPackage.ARC_TYPE__ARC, ArcType.class, msgs);
